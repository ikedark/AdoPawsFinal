...
class reporteEncontrado : AppCompatActivity() {
            ...
            mascotaRef.child(mascotaId).setValue(mascota)
                .addOnCompleteListener {
                    ...
                    btnAceptar?.setOnClickListener {
                        ...
                        dialog.dismiss()
                        Toast.makeText(this, "El reporte se genero correctamente", Toast.LENGTH_SHORT).show()
                    }
    ...
    private fun uploadImagen(){
        ...
        addOnSuccessListener {
            ...
            Toast.makeText(this@reporteEncontrado, "Imagen subida correctamente", Toast.LENGTH_SHORT).show()
            if (progressDialog.isShowing) progressDialog.dismiss()
        }. addOnFailureListener{
            if (progressDialog.isShowing) progressDialog.dismiss()
            Toast.makeText(this@reporteEncontrado, "Error", Toast.LENGTH_SHORT).show()
        }
