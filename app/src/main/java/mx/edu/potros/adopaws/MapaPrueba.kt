...
class MapaPrueba : AppCompatActivity(), OnMapReadyCallback, OnMyLocationButtonClickListener, OnMyLocationClickListener {
    ...
    private fun createMarker() {
        ...
        val coordinates6 = LatLng(27.474226, -109.942507)
        val coordinates7 = LatLng(27.449442, -109.922981)
        val coordinates8 = LatLng(27.497741, -109.939852)
        val coordinates9 = LatLng(27.494692, -109.945279)
        val coordinates10 = LatLng(27.470737, -109.963245)
        ...
        val marker6= MarkerOptions().position(coordinates6).title("Veterinaria MEDICANS")
        val marker7= MarkerOptions().position(coordinates7).title("Veterinaria MAF")
        val marker8= MarkerOptions().position(coordinates8).title("Veterinaria Dr. Hiram")
        val marker9= MarkerOptions().position(coordinates9).title("Veterinaria Dr. Zavala")
        val marker10= MarkerOptions().position(coordinates10).title("Veterinaria La chiquita")
